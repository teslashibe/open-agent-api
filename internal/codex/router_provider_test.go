...
func TestProviderForModel(t *testing.T) {
	cases := map[string]string{
		...
		"gemini-3.1-pro-high":       ProviderGemini,
		"gemini-pro-agent":          ProviderGemini,
		"claude-sonnet-4-6":         ProviderGemini,
		"claude-opus-4-6-thinking":  ProviderGemini,
		"gpt-oss-120b-medium":       ProviderGemini,
