...
```text
icebound-melida-unstoppably.ngrok-free.dev
```
...
```bash
curl -s https://icebound-melida-unstoppably.ngrok-free.dev/health
curl -s https://icebound-melida-unstoppably.ngrok-free.dev/v1/models | jq '.data[].id'
```
